...
export default class EditorPage extends Component {
  ...
  render() {
    ...
    const conver_HTML = editorContent
      ? draftToHtml(convertToRaw(editorContent.getCurrentContent()))
      : ''
    const conver_MarkDown = editorContent
      ? draftToMarkdown(convertToRaw(editorContent.getCurrentContent()))
      : ''
    const conver_JSON = editorContent
