...
const HSL = ({ match: { params } }) => (
  <div className="hsl" style={{ background: `hsl(${params.h}, ${params.s}%, ${params.l}%)` }}>
    <p>
...
const RGB = ({ match: { params } }) => (
  <div className="rgb" style={{ background: `rgb(${params.r}, ${params.g}, ${params.b})` }}>
    <p>
...
export default () => (
  <Router>
    <div className="router_transition_wrapper">
      <Route exact path="/animate/router-transition" render={() => <Redirect to="/animate/router-transition/hsl/10/90/50" />} />
      {/* 点击Link、在这里进行Route匹配 */}
      <Route
        render={({ location }) => (
          <div className="fill">
