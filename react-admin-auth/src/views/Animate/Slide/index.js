        ...
        <Row className="gutter-row">
          <Col className="gutter-col" md={12}>
            <Card title="slide-left">
              <Search placeholder="text" onSearch={value => this.add(value, 'leftList')} style={{ width: 200 }} enterButton="ADD" />
          ...
          <Col className="gutter-col" md={12}>
            <Card title="slide-right">
              <Search placeholder="text" onSearch={value => this.add(value, 'rightList')} style={{ width: 200 }} enterButton="ADD" />
              <div className="slide-view-box">
                <TransitionGroup>
          ...
          <Col className="gutter-col" md={12}>
            <Card title="slide-top">
              <Search placeholder="input search text" onSearch={value => this.add(value, 'topList')} style={{ width: 200 }} enterButton="ADD" />
              <div className="slide-view-box">
                <TransitionGroup>
          ...
          <Col className="gutter-col" md={12}>
            <Card title="slide-bottom">
              <Search placeholder="input search text" onSearch={value => this.add(value, 'bottomList')} style={{ width: 200 }} enterButton="ADD" />
              <div className="slide-view-box">
                <TransitionGroup>
