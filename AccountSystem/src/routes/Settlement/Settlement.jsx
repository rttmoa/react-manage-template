...
import {search, settlementClass, settlementContainer, productList, productListTitle} from './index.css';




function genSettlement({dispatch, settlement}){
    const { list, total,timeRange,loading,current,breadcrumbItems,settlementItems,settlementId } = settlement;
