...
export default connect(state => ({user: state.user}),{doLogout})(withRouter(AuthFrom));
...
//     }
// }
// export default connect(mapStateToProps, mapDispatchToProps)(withRouter(AuthFrom))
