...
export const reqWeather = city => {
    ...
    //   })
    // })
    return new Promise(reslove => reslove({ dayPictureUrl: 'https://gips3.baidu.com/it/u=2101432901,1526676003&fm=3028&app=3028&f=PNG&fmt=auto&q=100&size=f84_84', weather: '晴' }));
};
// reqWeather('北京')
/*
jsonp解决ajax跨域的原理
