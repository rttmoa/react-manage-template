...
export default class City extends React.Component {
    ...
    requestList = () => {
        ...
        //     })
        // })
        axiosJSON.get('https://mock.mengxuegu.com/mock/6517714296175e3c6ac1c6b7/city/open_city').then(res => {
            console.log(res);
            ...
            this.setState({
                list: list,
                pagination: Utils.pagination(res.data, current => { // TODO: 复用分页：pagination
                    _this.params.page = current;
                    _this.requestList();
                }),
            });
