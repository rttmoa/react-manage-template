...
export default class Order extends React.Component {
    ...
    requestList = () => {
        ...
        //     }
        // })
        axiosGET.get('https://mock.mengxuegu.com/mock/6517714296175e3c6ac1c6b7/role/list').then(res => {
            console.log(res);
            if (res.data) {
    ...
    getRoleUserList = id => {
        ...
        //     }
        // })
        axiosGET.get('https://mock.mengxuegu.com/mock/6517714296175e3c6ac1c6b7/role/user_list').then(res => {
            console.log(res);
            if (res) {
        ...
        return (
            <div>
                ...
                <div className="content-wrap">
                    <ETable updateSelectedItem={Utils.updateSelectedItem.bind(this)} selectedRowKeys={this.state.selectedRowKeys} dataSource={this.state.list} columns={columns} />
                </div>
                <Modal
                    title="创建角色"
                ...
                <Modal
                    ...
                    <RoleAuthForm wrappedComponentRef={inst => (this.userAuthForm = inst)} isClosed={this.state.isAuthClosed} detailInfo={this.state.detailInfo} targetKeys={this.state.targetKeys} mockData={this.state.mockData} patchUserInfo={this.patchUserInfo} />
                </Modal>
            </div>
        );
    }
