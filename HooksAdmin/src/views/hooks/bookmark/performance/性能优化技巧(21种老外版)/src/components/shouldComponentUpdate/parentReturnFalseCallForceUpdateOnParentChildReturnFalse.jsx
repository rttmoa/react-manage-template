/*
    ...
    ** The crux of the same is that the Child Component is called normally even if the Parent Component is called as "forceUpdate"
    ...
    The "shouldComponentUpdate" will execute on the Child Component also. and the returned value decides whether the component will rerender or

*/

import React from "react";

export default class ParentReturnFalseCallForceUpdateOnParentChildReturnFalse extends React.Component {
    constructor() {
        super();
        this.state = {
            name: "Mayank",
