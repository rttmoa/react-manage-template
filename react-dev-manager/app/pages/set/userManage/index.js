...
export default class app extends Component {
    ...
    return [
      ...
      },
      {
        ...
        render: (text, record, index) => {
          ...
          return <button onClick={this.handleUserRole.bind(this)}>{roleN || "普通用户"}</button>
        },
      },
      {
        title: "操作",
  ...
  render() {
    ...
    // console.log("userListResult", userListResult.list.splice(0, 10))
    userListResult.list = userListResult.list.splice(0, 10)
    return (
      <div 
